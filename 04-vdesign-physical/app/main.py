# =============================================================
# vDesign Physical — FastAPI Application Entry Point
# @GovernanceID vdesign-physical.0.0-BOOT
# =============================================================
import logging
...
app = FastAPI(
    title="vDesign Physical — I2S Physical Layer",
    version="1.0.0",
    lifespan=lifespan,
)
...
@app.get("/vdesign-physical/", include_in_schema=False)
async def vdesign_physical_ui_root():
